    ...
    return (
        <div className={styles.wrap}>
            <div className={styles.contentBox}>
                ...
                <button className={styles.answerBtn} onClick={openSearchModalHandler}>수신인 검색</button>
            ...
            <div className={styles.contentBox}>
                <span>첨부파일</span>
                <input type="file" name="uploadFile" multiple="multiple" onChange={imageLoad} ref={imgRef} accept="*"/>
            </div>
            <div className={styles.contentBox}>
                <span>내용</span>
