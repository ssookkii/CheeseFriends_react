    ...
    <div className="playInfoWrap">
      {showGameexp && 
        ...
        <div className="playInfo">
          <video muted autoPlay loop width="300" height="auto">
        ...
        <div className="playInfo" style={{width:800}}>
          ...
          <div className="InfoTxt">
            <h2>더 높이 날기 위해<br/><img src="/img/battery.png" width="40" height="40" style={{display:"inline-block"}}/>(배터리)를 챙기세요!</h2>
