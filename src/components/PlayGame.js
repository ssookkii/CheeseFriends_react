  ...
  return (
    ...
    <div>
      ...
      {showGameexp && <div className="divCenter">
        ...
        <p>'Start' 버튼을 누르면 게임이 시작되며 캐릭터가 비행을시작합니다.</p><br/>
        ...
        <h2>2. 장애물을 통과하여 점수를 획득하세요!</h2><br/>
        <video muted autoPlay loop width="200" height="auto">
          <source src="/img/game_1.mp4" type="video/mp4"/>
        </video>
        <p>장애물에 부딪히면 캐릭터가 추락하며 게임이 종료됩니다.</p><br/>
        <video muted autoPlay loop width="200" height="auto">
          <source src="/img/game_2.mp4" type="video/mp4"/>
        </video>
        <p>또한 게임 화면 좌측, 우측 경계에 부딪혀도 게임이 종료됩니다.</p><br/><br/>

        <h2>3. 더 높이 날기 위해 <img src="/img/battery.png" width="30" height="30" /> (배터리) 를 챙기세요!</h2><br/>
        <video muted autoPlay loop width="200" height="auto">
