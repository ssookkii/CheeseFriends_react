    ...
    return(
        <div>
            ...
            <tr>
                ...
                <td align="left">
                    <input type="radio" value="student" onChange={authChange} checked={auth === 'student'}/>학생
                    &nbsp;
                    <input type="radio" value="parents" onChange={authChange} checked={auth === 'parents'}/>학부모
                    &nbsp;
                    <input type="radio" value="teacher" onChange={authChange} checked={auth === 'teacher'}/>교사
                </td>
            </tr>
            <tr>
